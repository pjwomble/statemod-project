# example-0-5b.ctl;  Control file for StateMod Example 0-5b
#
...
# Located it upstream of DD1 bat node C4. Testing whether
...
#
  STATEMOD
  Example 0-5b - direct exchange (or24) from div wr to a plan (type11) - testing rediversion, split, shortages
