# example-0-5d.ctl;  Control file for StateMod Example 0-5d
#
...
#
  STATEMOD
  Example 0-5d - direct exchange (or24) from div wr to a plan (type11) - added a plan split to multiple plans for testing with the new type 24 “freeze” option
