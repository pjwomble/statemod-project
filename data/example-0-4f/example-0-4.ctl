# example-0-4.ctl;  Control file for StateMod Example 0-4
#
...
#
# this dataset is the same as 0-3, except the flows/demands/etc are
#   multipled by 100 to make it easier to detect conversion problems
...
#
  STATEMOD
  Example 0-4 - direct exchange (or24) from div wr to a plan (type11) - increased flows x 100
